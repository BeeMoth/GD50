...
function love.load()
	...
	player1b = Paddle(30, 30, 20, 5)
	player2b = Paddle(VIRTUAL_WIDTH - 45, VIRTUAL_HEIGHT - 15, 20, 5)
...
function love.update(dt)
    ...
    elseif gameState == 'play' then
        ...
        if ball.y >= VIRTUAL_HEIGHT - 15 then
            ball.y = VIRTUAL_HEIGHT - 15
            ball.dy = -ball.dy
            sounds['wall_hit']:play()
        end
